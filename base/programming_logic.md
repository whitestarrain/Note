...
面向对象的核心要素包括封装、继承、多态和抽象，它们共同支撑了面向对象的分析、设计和编程。

## 1.3. AOP

AOP（Aspect-Oriented Programming，面向切面编程）通过将横切关注点（如日志、事务、权限等）从业务逻辑中分离，实现模块化。

## 1.4. FP

FP（Functional Programming，函数式编程）强调不可变数据和纯函数，避免副作用，有利于并发编程和代码推理。
...
### 4.3.3. 误区：静态类型意味着预先设计或是瀑布开发模式（waterfall methods）
